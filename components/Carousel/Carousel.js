    class TabItem {
        constructor(Carousel__arrowright) {
          this.Carousel__arrowright = Carousel__arrow-right;
        }
      
        select() {
          this.Carousel__arrowright.classList.add("Carousel__arrowright--selected");
        }
      
        deselect() {
          this.Carousel__arrowright.classList.remove("Carousel__arrowright--selected");
        }
      }
      
      class Carousel__arrowright {
        constructor(element) {
      ...
      class Tabs {
        constructor(element) {
          ...
          this.activeData = element.querySelector(".Carousel__arrowright");
